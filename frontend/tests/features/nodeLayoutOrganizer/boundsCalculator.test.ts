...
import {
  BoundsCalculator,
  type Bounds,
} from '@/features/node-layout-organizer/utils/boundsCalculator'
...
describe('BoundsCalculator - calculateFitBounds', () => {
  it('centers within canvas and adds padding', () => {
    const positions: NodePosition[] = [{ id: 'a', x: 0, y: 0, width: 100, height: 100 }]
  ...
  it('constrains to canvas width when content is wider', () => {
    const positions: NodePosition[] = [{ id: 'a', x: 0, y: 0, width: 2000, height: 100 }]
  ...
  it('constrains to canvas height when content is taller', () => {
    const positions: NodePosition[] = [{ id: 'a', x: 0, y: 0, width: 100, height: 2000 }]
    const bounds = BoundsCalculator.calculateFitBounds(positions, 10, 1000, 500)
