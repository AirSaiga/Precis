 ...
 * 注：validateUnique 纯函数已下沉到 services/constraints/validators/unique，
 *     本文件保留导出以维持现有调用方的兼容性。
 */
...
import {
  validateUnique,
  type UniqueValidationResult,
} from '@/services/constraints/validators/unique'

export type { UniqueValidationResult }
export { validateUnique }
