    ...
    <div class="preflight-main">
      ...
      <div class="preflight-info">
        ...
        <div class="preflight-stats">
          <span
            >{{ t('common.fullValidation.task.preflight.unlistedResources') }}:
            {{ missingConstraints.length + missingRegexes.length }}</span
          >
          <span class="preflight-stat-sep">·</span>
          <span
            >{{ t('common.fullValidation.task.preflight.danglingResources') }}:
            {{ danglingConstraints.length + danglingRegexes.length }}</span
          >
        </div>
      </div>
      ...
      <span
        v-if="
          missingConstraints.length +
            missingRegexes.length +
            danglingConstraints.length +
            danglingRegexes.length >
          5
        "
