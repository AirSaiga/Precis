 ...
 * 主题类型
 * ====================================================================
 * - ThemePreference: 用户选择的主题（light/dark/system/liquid）
 * - ResolvedTheme: 实际生效的主题（light/dark/liquid）
 *
 * ====================================================================
 * 主题解析策略
 * ====================================================================
...
export type ThemePreference = 'light' | 'dark' | 'system' | 'liquid'
export type ResolvedTheme = 'light' | 'dark' | 'liquid'
