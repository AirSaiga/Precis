...
const expressions = {
  ...
  ruleConfigPanel: {
    ...
    syntaxErrorHint: 'The backend engine cannot execute this regex: {detail}',
  ...
  paramDefinitionModal: {
    ...
    paramNameInvalid:
      'Parameter names may only contain letters, digits and underscores, and cannot start with a digit (e.g. amount, col_2)',
  },
  ruleTestPanel: {
